...
\begin{figure}
\begin{centering} 
\subfigure[Large Image, Filter Width = $10$]{ \includegraphics[width=0.48\textwidth]{images/gpuhw10} \label{fig:hw10}} 
\subfigure[Large Image, Filter Width = $5$]{ \includegraphics[width=0.48\textwidth]{images/gpuhw5} \label{fig:hw5} } 
\subfigure[Smaller Image, Filter Width = $10$]{ \includegraphics[width=0.48\textwidth]{images/gpuhw10light} \label{fig:hw10light} } 
\subfigure[Smaller Image, Filter Width = $5$]{ \includegraphics[width=0.48\textwidth]{images/gpuhw5light} \label{fig:hw5light} } 
\end{centering}
...
AMD Shanghai similarly shows an impressive speedup of 20.92x (Figure~\ref{fig:ShanghaiFinal}). The interesting case is with AMD Phenom as shown in Figure~\ref{fig:PhenomFinal}. The speedup drops a little as number of cores increases beyond three. The reason behind this is the turbo core technology; when there are a maximum of three cores being used, the clock frequency scales up to 3.6 $GH_z$ but as soon as more threads are created the clock frequency steps down to 2.7 $GH_z$. 
